...
/* harmony export */   "BodyEditor": () => (/* binding */ BodyEditor)
/* harmony export */ });
...
var BodyEditor = function BodyEditor(_ref) {
  var body = _ref.body,
      templateName = _ref.templateName,
      templateType = _ref.templateType,
      onUseTimeRangeAsIntervalChange = _ref.onUseTimeRangeAsIntervalChange,
      onTemplateNameChange = _ref.onTemplateNameChange,
      onTemplateTypeChange = _ref.onTemplateTypeChange,
      useTimeRangeAsInterval = _ref.useTimeRangeAsInterval,
      onBodyChange = _ref.onBodyChange,
      useHorusTemplate = _ref.useHorusTemplateBody,
      onUseHorusTemplateChange = _ref.onUseHorusTemplateBodyChange,
      onBlur = _ref.onTemplateBlur;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react__WEBPACK_IMPORTED_MODULE_1___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineFieldRow, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineSwitch, {
    marginWidth: 2,
    marginHeight: 2,
    ...
    onChange: function onChange(e) {
      return onUseHorusTemplateChange(e.currentTarget.checked);
    }
    ...
    onChange: function onChange(e) {
      return onUseTimeRangeAsIntervalChange(e.currentTarget.checked);
    },
    onBlur: onBlur
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineFieldRow, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineField, {
    label: "Template Name"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.Input, {
    value: templateName,
    onChange: function onChange(e) {
      return onTemplateNameChange(e.currentTarget.value);
    },
    onBlur: onBlur,
    width: 35
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineFieldRow, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineField, {
    ...
    value: templateType,
    onChange: function onChange(e) {
      return onTemplateTypeChange(e.currentTarget.value);
    },
    onBlur: onBlur,
    width: 35
  })))), useHorusTemplate === false && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.InlineFieldRow, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__.CodeEditor, {
    value: body || '',
    language: 'json',
    width: "800px",
    height: "300px",
...
/* harmony import */ var _BodyEditor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./BodyEditor */ "./components/BodyEditor.tsx");
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var TabbedQueryEditor = function TabbedQueryEditor(_ref) {
  ...
  var onTemplateNameChange = function onTemplateNameChange(name) {
    console.log(name);
    onChange(_extends({}, q, {
      horusTemplate: _extends({}, q.horusTemplate, {
        TEMPLATE_NAME: name
      })
    }));
  };

  var onTemplateTypeChange = function onTemplateTypeChange(type) {
    onChange(_extends({}, q, {
      horusTemplate: _extends({}, q.horusTemplate, {
        TEMPLATE_TYPE: type
      })
  ...
  var onUseTimeRangeAsIntervalChange = function onUseTimeRangeAsIntervalChange(use) {
    onChange(_extends({}, q, {
      useTimeRangeAsInterval: use
    }));
    onRunQuery();
  };

  var _onTemplateBlur = function onTemplateBlur() {
    onRunQuery();
  };
  ...
  var tabs = [{
    ...
    title: 'Body',
    content: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_BodyEditor__WEBPACK_IMPORTED_MODULE_8__.BodyEditor, {
      body: q.body,
      ...
      onUseHorusTemplateBodyChange: function onUseHorusTemplateBodyChange(use) {
        return onChange(_extends({}, q, {
          useHorusTemplateBody: use
        }));
      },
      onTemplateNameChange: onTemplateNameChange,
      onTemplateTypeChange: onTemplateTypeChange,
      onUseTimeRangeAsIntervalChange: onUseTimeRangeAsIntervalChange,
      onTemplateBlur: function onTemplateBlur() {
        return _onTemplateBlur();
      }
    })
  }];
...
/* harmony import */ var _templateInterval__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./templateInterval */ "./templateInterval.ts");
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! short-uuid */ "../node_modules/short-uuid/index.js");
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(short_uuid__WEBPACK_IMPORTED_MODULE_10__);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  _createClass(DataSource, [{
    ...
    value: function query(options) {
      ...
      var streams = options.targets.map(function (target) {
        // Get query
        var query = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(target, _types__WEBPACK_IMPORTED_MODULE_4__.defaultQuery); // Horus Template Body

        if (query.useHorusTemplateBody) {
          if (query.useTimeRangeAsInterval) {
            query.horusTemplate.INTERVAL = (0,_templateInterval__WEBPACK_IMPORTED_MODULE_9__.GetCurrentTemplateInterval)(options);
          }
        ...
        if (query.dataGroupId.length === 0) {
          query.dataGroupId = short_uuid__WEBPACK_IMPORTED_MODULE_10___default().generate();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GetCurrentTemplateInterval": () => (/* binding */ GetCurrentTemplateInterval)
/* harmony export */ });
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @grafana/data */ "@grafana/data");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_grafana_data__WEBPACK_IMPORTED_MODULE_0__);
