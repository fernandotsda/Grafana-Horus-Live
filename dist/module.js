define(["@grafana/data","@grafana/runtime","@grafana/ui","emotion","lodash","react","rxjs"], (__WEBPACK_EXTERNAL_MODULE__grafana_data__, __WEBPACK_EXTERNAL_MODULE__grafana_runtime__, __WEBPACK_EXTERNAL_MODULE__grafana_ui__, __WEBPACK_EXTERNAL_MODULE_emotion__, __WEBPACK_EXTERNAL_MODULE_lodash__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_rxjs__) => { return /******/ (() => { // webpackBootstrap
...
var VariableQueryEditor = function VariableQueryEditor(_ref) {
  ...
  var saveQuery = function saveQuery() {
    onChange(state, "".concat(state.capacity, "-(").concat(state.capacity, ")"));
  };

  var handleChange = function handleChange(event) {
    return setState(_extends({}, state, _defineProperty({}, event.currentTarget.name, event.currentTarget.value)));
  };

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "gf-form"
  }, _span || (_span = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "gf-form-label width-10"
  }, "Namespace")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
    name: "namespace",
    ...
    className: "gf-form"
  }, _span2 || (_span2 = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "gf-form-label width-10"
...
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! short-uuid */ "../node_modules/short-uuid/index.js");
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(short_uuid__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _horusTemplate__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./horusTemplate */ "./horusTemplate.ts");
/* harmony import */ var _variableHandler__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./variableHandler */ "./variableHandler.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
      ...
      var streams = options.targets.map(function (target) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_1__.Observable(function (subscriber) {
          ...
          if (!query.unoverridable) {
            try {
              (0,_variableHandler__WEBPACK_IMPORTED_MODULE_11__.OverrideQueryWithVariables)(query);
            } catch (e) {
              subscriber.error(e);
            }
          ...
          if (query.dataGroupId.length === 0) {
            query.dataGroupId = short_uuid__WEBPACK_IMPORTED_MODULE_9___default().generate();
          } // Use horus template


          if (query.useHorusTemplateBody) {
            (0,_horusTemplate__WEBPACK_IMPORTED_MODULE_10__.SetBodyAsHorusTemplate)(query, options);
          } // Get data history
          ...
          var queryRes = new _queryResponse__WEBPACK_IMPORTED_MODULE_5__.QueryResponseHandler({
            data: [frame],
            key: query.refId,
            state: _grafana_data__WEBPACK_IMPORTED_MODULE_3__.LoadingState.Loading
          ...
          var loop = new _looper__WEBPACK_IMPORTED_MODULE_8__.Loop(func, query.interval); // Fast start
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SetBodyAsHorusTemplate": () => (/* binding */ SetBodyAsHorusTemplate)
/* harmony export */ });
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @grafana/data */ "@grafana/data");
/* harmony import */ var _grafana_data__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_grafana_data__WEBPACK_IMPORTED_MODULE_0__);
 ...
 */
function SetBodyAsHorusTemplate(query, options) {
  var horusTemplate = {
...
function GetCurrentTemplateInterval(options) {
  var from = (0,_grafana_data__WEBPACK_IMPORTED_MODULE_0__.dateTimeParse)((0,_grafana_data__WEBPACK_IMPORTED_MODULE_0__.dateTime)(options.range.from)).toDate();
  var to = (0,_grafana_data__WEBPACK_IMPORTED_MODULE_0__.dateTimeParse)(options.range.to).toDate();
  return "".concat(from.getUTCFullYear(), "-").concat(twoDigit(from.getUTCMonth() + 1), "-").concat(twoDigit(from.getUTCDate()), " : ").concat(twoDigit(to.getUTCFullYear()), "-").concat(twoDigit(to.getUTCMonth() + 1), "-").concat(twoDigit(to.getUTCDate()));
}
/**
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "OverrideQueryWithVariables": () => (/* binding */ OverrideQueryWithVariables)
/* harmony export */ });
 ...
 * @returns void
 */
function OverrideQueryWithVariables(query) {
  var variables = (0,_grafana_runtime__WEBPACK_IMPORTED_MODULE_0__.getTemplateSrv)().getVariables();
  variables.forEach(function (v) {
    // Get variable name which will be used as query key
    var variableAsKey = v.name; // Check if key exist in query

    if (variableAsKey in query) {
      var _options;

      // Transform to type any
      var queryAsAny = query; // Get raw value selected

      var rawValue = '';
      (_options = v['options']) === null || _options === void 0 ? void 0 : _options.forEach(function (opt) {
        if (!opt) {
          return;
        }
        ...
        if (opt['selected']) {
          ...
          rawValue = (_opt$value = opt['value']) !== null && _opt$value !== void 0 ? _opt$value : '';
        }
      }); // Get field type

      var fieldType = _typeof(queryAsAny[variableAsKey]);
      ...
      if (fieldType === 'string') {
        ...
        /*Invalid value*/
          ...
          throw new Error("Invalid variable (".concat(variableAsKey, ") value, received: ").concat(rawValue, ", expected: \"true\" or \"false\""));
        }
      } else if (fieldType === 'number') {
        // Parse to number
        var valueAsNumber = Number(rawValue); // Validate value

        if (isNaN(valueAsNumber)) {
          throw new Error("Invalid variable (".concat(variableAsKey, ") value, received: ").concat(rawValue, ", expected: value typeof number"));
        }

        queryAsAny[variableAsKey] = valueAsNumber;
      } else {
        // Throw error if field is unsupported
        throw new Error("Unsupported variable override: ".concat(variableAsKey));
      }
    } else {
      // Throw error if key doesn't exist in query
      throw new Error("Unknown variable: ".concat(variableAsKey));
    }
  });
}
...
/* harmony import */ var _components_VariableQueryEditor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/VariableQueryEditor */ "./components/VariableQueryEditor.tsx");


 // import { QueryEditor } from './components/QueryEditor';


var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__.DataSourcePlugin(_datasource__WEBPACK_IMPORTED_MODULE_1__.DataSource).setConfigEditor(_components_ConfigEditor__WEBPACK_IMPORTED_MODULE_2__.ConfigEditor).setVariableQueryEditor(_components_VariableQueryEditor__WEBPACK_IMPORTED_MODULE_3__.VariableQueryEditor);
})();
