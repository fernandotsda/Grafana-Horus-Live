...
var DataController = /*#__PURE__*/function () {
  ...
  _createClass(DataController, [{
    ...
    value: function Find(id) {
      return this.history.find(function (h) {
        return h.id === id;
      });
    }
  }, {
...
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! short-uuid */ "../node_modules/short-uuid/index.js");
/* harmony import */ var short_uuid__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(short_uuid__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _looper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./looper */ "./looper.ts");
  ...
  _createClass(DataSource, [{
    ...
    value: function query(options) {
      ...
      var streams = options.targets.map(function (target) {
        // Get query
        var query = lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()(target, _types__WEBPACK_IMPORTED_MODULE_4__.defaultQuery); // Create unic groupID

        if (query.dataGroupId.length === 0) {
          query.dataGroupId = short_uuid__WEBPACK_IMPORTED_MODULE_8___default().generate().toString();
        } // Get data history


        var dataHistory = _this2.dataController.Get(query); // Inicialize and return Observable
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_1__.Observable(function (subscriber) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 13:
                      ...
                      // Clear request
                      _this2.dataController.ClearRequest(query);
                    ...
                    case 18:
                      // Add data to frame
                      try {
                        (0,_dataHandler__WEBPACK_IMPORTED_MODULE_7__.AddDataToQueryFrame)(frame, query, res);
                      } catch (e) {
                        subscriber.error(e);
                      } // Add data to history
          ...
          return (0,_looper__WEBPACK_IMPORTED_MODULE_9__.Newloop)(func, query.interval);
        });
      });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Newloop": () => (/* binding */ Newloop)
/* harmony export */ });
/* harmony import */ var _dataHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dataHandler */ "./dataHandler.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
